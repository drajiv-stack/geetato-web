        ...
        <div className="w-full max-w-md relative z-10">
          <Card className="p-8 bg-white shadow-3d rounded-3xl border-2 border-[#E85D75]/10">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-[#E85D75] to-[#F4A261] mb-4 shadow-3d">
                <Sparkles className="w-8 h-8 text-white animate-pulse" />
              </div>
              <p className="text-[#5D4037]/70">Loading...</p>
            </div>
          </Card>
        </div>
      }>
